...
<div class="container">
  ...
  <div class="form-group">
        ...
        <div class="page__group">  
          ...
          <div class="form-group">
            <p>¿Que te parece la plataforma educativa?</p> 
           <div class="page__group">  
          <div class="rating">
            ...
            <input type="radio" name="rating-star3" class="rating__control screen-reader" id="rc13" checked>
            <input type="radio" name="rating-star3" class="rating__control screen-reader" id="rc14">
            <input type="radio" name="rating-star3" class="rating__control screen-reader" id="rc15">
    ...
    <div class="form-group">
      ...
      <textarea id="comments" class="input-textarea" name="comment" placeholder="Deje su comentario aquí..."></textarea>
    </div>
    <div class="form-group">
...
<!-- partial -->
  <script  src="./Encuescript.js"></script>
